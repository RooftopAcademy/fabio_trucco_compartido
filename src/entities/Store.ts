...
export default class Store {
    ...
    fetchProducts(): void {
        ...
        let data = [
            ...
            image: "/images/chess-sets/chess-set-7.png", buys: 12, guarantee: 1}
        ]
